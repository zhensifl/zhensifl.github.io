...
function finishPlacement(level){const previous={...state};state.level=level;state.placementDone=true;saveChangedSettings(previous);setModalOpen("#placement-modal",false);populateEnhancedSettings();renderDashboard();renderLibrary();renderProgress();showToast(`已切换到 ${level} 词汇等级`)}
...
window.WordStepEnhancements={version:"20260907-1",retrievability,nextSchedule,openPlacement,exportProgress,migrateLegacyMemoryState,vocabularyLevel};
