...
function phraseHintHtml(word){return word.phrase?`<div class="phrase-hint"><span>常用搭配</span><strong>${escapeAttr(word.phrase)}</strong><small>${escapeAttr(word.phraseZh||"")}</small></div>`:""}
