...
function vocabularyLevel(word){
  ...
  if(CURATED_CEFR_LEVELS[en])return CURATED_CEFR_LEVELS[en];
  let level=window.CEFRJ_LEVELS?.[en];
  ...
  if(level==="A2"&&complexA2)level="B1";
  if(level==="B1"&&complexB1)level="B2";
  return level;
}
...
window.WordStepEnhancements={version:"20260831-4",retrievability,nextSchedule,openPlacement,exportProgress,migrateLegacyMemoryState,vocabularyLevel};
