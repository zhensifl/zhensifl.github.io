...
function isUsefulVocabulary(word){return word.senseVersion==="20260903-1"&&word.qualityReady===true&&word.en.length>=3&&Number(word.frequencyRank||Infinity)>=MIN_GENERATED_RANK&&!word.base&&!word.proper&&!EXCLUDED_WORDS.has(word.en.toLowerCase())&&!/(?:男子名|女子名|人名|城市名|州名|国家名|国名|首都)/.test(word.zh)}
