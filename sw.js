const CACHE_NAME="wordstep-20260907-2";
const SHELL=["./","./index.html","./styles.css","./app-20260907-2.js","./enhancements-20260907-2.js","./sync-model-20260907-2.js","./manifest.webmanifest","./icon.svg","./icon-32.png","./icon-192.png","./icon-512.png","./icon-maskable-512.png","./apple-touch-icon.png","./version.json"];
...
self.addEventListener("install",event=>event.waitUntil(caches.open(CACHE_NAME).then(async cache=>{
  await cache.addAll([...SHELL,"./vocabulary-refinements-20260907-2.js","./vocabulary-corrections-20260906-1.js","./vocabulary-focus-20260907-2.js"]);
