...
function finishPlacement(level){
  ...
  state.level=level;state.placementDone=true;saveChangedSettings(previous);setModalOpen("#placement-modal",false);populateEnhancedSettings();renderDashboard();renderLibrary();renderProgress();showToast(`已切换到 ${level}，已认识的基础词会自动跳过`)
}
...
window.WordStepEnhancements={version:"20260907-7",retrievability,nextSchedule,openPlacement,exportProgress,migrateLegacyMemoryState,vocabularyLevel};
